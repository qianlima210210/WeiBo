...
#import "BYStatKeyChainStore.h"

NSString * const BYKeyChainStoreErrorDomain = @"com.kishikawakatsumi.bykeychainstore";
static NSString *_defaultService;

@interface BYStatKeyChainStore ()

@end

@implementation BYStatKeyChainStore
...
+ (BYStatKeyChainStore *)keyChainStoreWithService:(NSString *)service
{
    return [[self alloc] initWithService:service accessGroup:nil];
}

+ (BYStatKeyChainStore *)keyChainStoreWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
...
{
    return [[self alloc] initWithServer:server protocolType:protocolType authenticationType:BYKeyChainStoreAuthenticationTypeDefault];
}
...
- (instancetype)initWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
    self = [super init];
    if (self) {
        _itemClass = BYKeyChainStoreItemClassGenericPassword;
...
{
    return [self initWithServer:server protocolType:protocolType authenticationType:BYKeyChainStoreAuthenticationTypeDefault];
}
...
- (instancetype)initWithServer:(NSURL *)server protocolType:(BYKeyChainStoreProtocolType)protocolType authenticationType:(BYKeyChainStoreAuthenticationType)authenticationType
{
    self = [super init];
    if (self) {
        _itemClass = BYKeyChainStoreItemClassInternetPassword;
...
- (void)commonInit
{
    _accessibility = BYKeyChainStoreAccessibilityAfterFirstUnlock;
}
...
+ (NSString *)stringForKey:(NSString *)key service:(NSString *)service accessGroup:(NSString *)accessGroup error:(NSError *__autoreleasing *)error
{
    ...
    BYStatKeyChainStore *keychain = [BYStatKeyChainStore keyChainStoreWithService:service accessGroup:accessGroup];
...
+ (NSArray BY_KEY_TYPE *)allKeysWithItemClass:(BYKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == BYKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
    } else if (itemClass == BYKeyChainStoreItemClassInternetPassword) {
...
+ (NSArray *)allItemsWithItemClass:(BYKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == BYKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
...
+ (void)requestSharedWebCredentialWithCompletion:(void (^)(NSArray BY_CREDENTIAL_TYPE *credentials, NSError *error))completion
{
    [self requestSharedWebCredentialForDomain:nil account:nil completion:completion];
}

+ (void)requestSharedWebCredentialForDomain:(NSString *)domain account:(NSString *)account completion:(void (^)(NSArray BY_CREDENTIAL_TYPE *credentials, NSError *error))completion
{
...
- (NSMutableDictionary *)attributesWithKey:(NSString *)key value:(NSData *)value error:(NSError *__autoreleasing *)error
{
    ...
    if (_authenticationPolicy && accessibilityObject) {
        ...
        if (floor(NSFoundationVersionNumber) <= floor(iOS_7_1_or_10_9_2) && _accessibility == BYKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly) {
#if TARGET_OS_IOS
            NSLog(@"%@", @"Unavailable 'BYKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly' attribute on iOS versions prior to 8.0.");
#else
            NSLog(@"%@", @"Unavailable 'BYKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly' attribute on OS X versions prior to 10.10.");
#endif
        } else {
...
{
    switch (_itemClass) {
        case BYKeyChainStoreItemClassGenericPassword:
            return kSecClassGenericPassword;
        case BYKeyChainStoreItemClassInternetPassword:
...
- (CFTypeRef)protocolTypeObject
{
    switch (_protocolType) {
        case BYKeyChainStoreProtocolTypeFTP:
            return kSecAttrProtocolFTP;
        case BYKeyChainStoreProtocolTypeFTPAccount:
            return kSecAttrProtocolFTPAccount;
        case BYKeyChainStoreProtocolTypeHTTP:
            return kSecAttrProtocolHTTP;
        case BYKeyChainStoreProtocolTypeIRC:
            return kSecAttrProtocolIRC;
        case BYKeyChainStoreProtocolTypeNNTP:
            return kSecAttrProtocolNNTP;
        case BYKeyChainStoreProtocolTypePOP3:
            return kSecAttrProtocolPOP3;
        case BYKeyChainStoreProtocolTypeSMTP:
            return kSecAttrProtocolSMTP;
        case BYKeyChainStoreProtocolTypeSOCKS:
            return kSecAttrProtocolSOCKS;
        case BYKeyChainStoreProtocolTypeIMAP:
            return kSecAttrProtocolIMAP;
        case BYKeyChainStoreProtocolTypeLDAP:
            return kSecAttrProtocolLDAP;
        case BYKeyChainStoreProtocolTypeAppleTalk:
            return kSecAttrProtocolAppleTalk;
        case BYKeyChainStoreProtocolTypeAFP:
            return kSecAttrProtocolAFP;
        case BYKeyChainStoreProtocolTypeTelnet:
            return kSecAttrProtocolTelnet;
        case BYKeyChainStoreProtocolTypeSSH:
            return kSecAttrProtocolSSH;
        case BYKeyChainStoreProtocolTypeFTPS:
            return kSecAttrProtocolFTPS;
        case BYKeyChainStoreProtocolTypeHTTPS:
            return kSecAttrProtocolHTTPS;
        case BYKeyChainStoreProtocolTypeHTTPProxy:
            return kSecAttrProtocolHTTPProxy;
        case BYKeyChainStoreProtocolTypeHTTPSProxy:
            return kSecAttrProtocolHTTPSProxy;
        case BYKeyChainStoreProtocolTypeFTPProxy:
            return kSecAttrProtocolFTPProxy;
        case BYKeyChainStoreProtocolTypeSMB:
            return kSecAttrProtocolSMB;
        case BYKeyChainStoreProtocolTypeRTSP:
            return kSecAttrProtocolRTSP;
        case BYKeyChainStoreProtocolTypeRTSPProxy:
            return kSecAttrProtocolRTSPProxy;
        case BYKeyChainStoreProtocolTypeDAAP:
            return kSecAttrProtocolDAAP;
        case BYKeyChainStoreProtocolTypeEPPC:
            return kSecAttrProtocolEPPC;
        case BYKeyChainStoreProtocolTypeNNTPS:
            return kSecAttrProtocolNNTPS;
        case BYKeyChainStoreProtocolTypeLDAPS:
            return kSecAttrProtocolLDAPS;
        case BYKeyChainStoreProtocolTypeTelnetS:
            return kSecAttrProtocolTelnetS;
        case BYKeyChainStoreProtocolTypeIRCS:
            return kSecAttrProtocolIRCS;
        case BYKeyChainStoreProtocolTypePOP3S:
...
- (CFTypeRef)authenticationTypeObject
{
    switch (_authenticationType) {
        case BYKeyChainStoreAuthenticationTypeNTLM:
            return kSecAttrAuthenticationTypeNTLM;
        case BYKeyChainStoreAuthenticationTypeMSN:
            return kSecAttrAuthenticationTypeMSN;
        case BYKeyChainStoreAuthenticationTypeDPA:
            return kSecAttrAuthenticationTypeDPA;
        case BYKeyChainStoreAuthenticationTypeRPA:
            return kSecAttrAuthenticationTypeRPA;
        case BYKeyChainStoreAuthenticationTypeHTTPBasic:
            return kSecAttrAuthenticationTypeHTTPBasic;
        case BYKeyChainStoreAuthenticationTypeHTTPDigest:
            return kSecAttrAuthenticationTypeHTTPDigest;
        case BYKeyChainStoreAuthenticationTypeHTMLForm:
            return kSecAttrAuthenticationTypeHTMLForm;
        case BYKeyChainStoreAuthenticationTypeDefault:
...
- (CFTypeRef)accessibilityObject
{
    switch (_accessibility) {
        case BYKeyChainStoreAccessibilityWhenUnlocked:
            return kSecAttrAccessibleWhenUnlocked;
        case BYKeyChainStoreAccessibilityAfterFirstUnlock:
            return kSecAttrAccessibleAfterFirstUnlock;
        case BYKeyChainStoreAccessibilityAlways:
            return kSecAttrAccessibleAlways;
        case BYKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly:
            return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
        case BYKeyChainStoreAccessibilityWhenUnlockedThisDeviceOnly:
            return kSecAttrAccessibleWhenUnlockedThisDeviceOnly;
        case BYKeyChainStoreAccessibilityAfterFirstUnlockThisDeviceOnly:
            return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
        case BYKeyChainStoreAccessibilityAlwaysThisDeviceOnly:
...
{
    NSError *error = [NSError errorWithDomain:BYKeyChainStoreErrorDomain code:BYKeyChainStoreErrorInvalidArguments userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:BYKeyChainStoreErrorDomain code:-67594 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
...
#endif
    NSError *error = [NSError errorWithDomain:BYKeyChainStoreErrorDomain code:status userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:BYKeyChainStoreErrorDomain code:-99999 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
