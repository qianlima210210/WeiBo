...
@implementation BYStatUUID

NSString *const BYUUIDsOfUserDevicesDidChangeNotification = @"BYUUIDsOfUserDevicesDidChangeNotification";


NSString *const _uuidForInstallationKey = @"by_uuidForInstallation";
NSString *const _uuidForDeviceKey = @"by_uuidForDevice";
NSString *const _uuidsOfUserDevicesKey = @"by_uuidsOfUserDevices";
NSString *const _uuidsOfUserDevicesToggleKey = @"by_uuidsOfUserDevicesToggle";


+(BYStatUUID *)sharedInstance
{
    static BYStatUUID *instance = nil;
...
-(NSString *)_getValueForKey:(NSString *)key userDefaults:(BOOL)userDefaults keychain:(BOOL)keychain service:(NSString *)service accessGroup:(NSString *)accessGroup
{
    ...
    if(!value && keychain ){
        value = [BYStatKeyChainStore stringForKey:key service:service accessGroup:accessGroup];
    }
...
-(void)uuidsOfUserDevices_iCloudChange:(NSNotification *)notification
{
    if( _uuidsOfUserDevices_iCloudAvailable )
    {
        ...
        if([uuidsSet count] > uuidsCount)
        {
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:BYUUIDsOfUserDevicesDidChangeNotification object:self userInfo:userInfo];
        }
    }
}
