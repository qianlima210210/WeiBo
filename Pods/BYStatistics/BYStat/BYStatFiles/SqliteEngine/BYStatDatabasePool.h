...
@class BYStatDatabase;

/** Pool of `<BYStatDatabase>` objects.
 ...
 @warning Before using `BYStatDatabasePool`, please consider using `<BYStatDatabaseQueue>` instead.

 If you really really really know what you're doing and `BYStatDatabasePool` is what
 you really really need (ie, you're using a read only database), OK you can use
 it.  But just be careful not to deadlock!

 For an example on deadlocking, search for:
 `ONLY_USE_THE_POOL_IF_YOU_ARE_DOING_READS_OTHERWISE_YOULL_DEADLOCK_USE_BYStatDATABASEQUEUE_INSTEAD`
 in the main.m file.
 */

@interface BYStatDatabasePool : NSObject
...
/** Create pool using path.
 ...
 @return The `BYStatDatabasePool` object. `nil` on error.
 */
...
/** Synchronously perform database operations in pool.
 ...
 @param block The code to be run on the `BYStatDatabasePool` pool.
 */
...
/** Synchronously perform database operations in pool using save point.
 ...
 @warning You can not nest these, since calling it will pull another database out of the pool and you'll get a deadlock. If you need to nest, use `<[BYStatDatabase startSavePointWithName:error:]>` instead.
*/
...
/** BYStatDatabasePool delegate category
 
 This is a category that defines the protocol for the BYStatDatabasePool delegate
 */

@interface NSObject (BYStatDatabasePoolDelegate)

/** Asks the delegate whether database should be added to the pool. 
 
 @param pool     The `BYStatDatabasePool` object.
 @param database The `BYStatDatabase` object.
 
 @return `YES` if it should add database to pool; `NO` if not.
 
 */

- (BOOL)databasePool:(BYStatDatabasePool*)pool shouldAddDatabaseToPool:(BYStatDatabase*)database;
...
- (void)databasePool:(BYStatDatabasePool*)pool didAddDatabase:(BYStatDatabase*)database;
