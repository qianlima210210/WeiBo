...
/** Category of additions for `<BYStatDatabase>` class.
...
@interface BYStatDatabase (BYStatDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `BYStatResultSet` of schema; `nil` on error.
