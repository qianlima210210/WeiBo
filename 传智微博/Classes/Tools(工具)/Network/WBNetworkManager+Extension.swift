...
extension WBNetworkManager {
    ...
    func statusList(since_id: Int64 = 0, max_id: Int64 = 0, completion: (_ list: [[String: AnyObject]]?, _ isSuccess: Bool)->()) {
...
extension WBNetworkManager {
    ...
    func postStatus(text: String, image: UIImage?, completion: (_ result: [String: AnyObject]?, _ isSuccess: Bool)->()) -> () {
...
extension WBNetworkManager {
    ...
    /// 加载当前用户信息 - 用户登录后立即执行
    func loadUserInfo(completion: (_ dict: [String: AnyObject])->()) {
...
extension WBNetworkManager {
    ...
    func loadAccessToken(code: String, completion: (_ isSuccess: Bool)->()) {
