...
class WBNetworkManager: AFHTTPSessionManager {
    ...
    /// - parameter completion: 完成回调
    func upload(URLString: String, parameters: [String: AnyObject]?, name: String, data: Data, completion: (_ json: AnyObject?, _ isSuccess: Bool)->()) {
    ...
    func request(method: WBHTTPMethod = .GET, URLString: String, parameters: [String: AnyObject]?, completion: (_ json: AnyObject?, _ isSuccess: Bool)->()) {
